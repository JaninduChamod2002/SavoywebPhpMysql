...
<!----------------------------------------------------------------->
  ...
  <div class="usern"><center><b>Movie Schedules</center></b></div>
            <div class="wrapper">
              <div class="left">
...
<!--information-->
        ...
        <h3>SCHEDULE INFORMATION</h3><hr/><br/>  
                ...
                <p>Movie No:- <?php echo $user_data['movie_no'];?> </p><br>
                <p>Movie Name:- <?php echo $user_data['movie_name'];?> </p><br>
                <p>Start Time:- <?php echo $user_data['start_time'];?> </p><br>
                <p>End Time:- <?php echo $user_data['end_time'];?> </p><br>
                <p>Interval Start Time:- <?php echo $user_data['interval_start_time'];?> </p><br>
                <p>Interval End Time:- <?php echo $user_data['interval_end_time'];?> </p><br>
